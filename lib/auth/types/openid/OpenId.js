...
export default class OpenId extends AuthType {
    ...
    async authenticate(credentials)  {
        ...
        try {
            console.log("Authenticate function called on extended OpenId.js with credentials: ");
            console.log(JSON.stringify(credentials));
            console.log("authHeaderName": this.authHeaderName);
            ...
            try {
                ...
                console.log("Something went wrong while parsing the payload, but the user was authenticated correctly.");
            ...
            console.log("Catch 1. Error: " + JSON.stringify(error));
            throw error
        }
    }

    onUnAuthenticated(request, h, error) {
        console.log("onUnAuthenticated openid.js");
