    ...
    setupAuthScheme() {
        this.server.auth.scheme('security_access_control_scheme', (server, options) => ({
            authenticate: async(request, h) => {
                console.log("Setup Auth Scheme authenticate function");
                ...
                try {
                    ...
                    if (this._cookieValidationError) {
                        console.log("cookie validation error: " + this._cookieValidationError);
                    ...
                    console.log("authHeaderCredentials: " + authHeaderCredentials)
